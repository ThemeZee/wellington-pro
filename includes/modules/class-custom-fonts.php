...
class Wellington_Pro_Custom_Fonts {
	...
	static function setup() {
		...
		require_once WELLINGTON_PRO_PLUGIN_DIR . 'includes/customizer/class-font-list.php';
		require_once WELLINGTON_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-control.php';
		require_once WELLINGTON_PRO_PLUGIN_DIR . 'includes/customizer/class-customize-font-list-control.php';
		...
		add_filter( 'wellington_google_fonts_url', array( __CLASS__, 'google_fonts_url' ) );
	 ...
	 *
	 * @uses wellington_google_fonts_url filter hook
	...
	static function google_fonts_url( $google_fonts_url ) {
		...
		$default_fonts = Wellington_Pro_Custom_Font_Lists::default_browser_fonts();
	...
	static function font_settings( $wp_customize ) {
		...
		$wp_customize->add_section( 'wellington_pro_section_fonts', array(
			'title'    => __( 'Theme Fonts', 'wellington-pro' ),
			'priority' => 70,
		...
		$wp_customize->add_setting( 'wellington_theme_options[available_fonts]', array(
			'default'           => 'favorites',
			'type'           	=> 'option',
			'transport'         => 'postMessage',
			'sanitize_callback' => array( 'Wellington_Pro_Custom_Fonts', 'sanitize_available_fonts' ),
			)
		);
		$wp_customize->add_control( new Wellington_Pro_Customize_Font_List_Control(
			$wp_customize, 'wellington_control_available_fonts', array(
				'label'      => __( 'Choose available Fonts', 'wellington-pro' ),
				'section'    => 'wellington_pro_section_fonts',
				'settings'   => 'wellington_theme_options[available_fonts]',
				'choices' => array(
					'default' => __( 'Default Browser Fonts (12)', 'wellington-pro' ),
					'favorites' => __( 'ThemeZee Favorite Fonts (35)', 'wellington-pro' ),
