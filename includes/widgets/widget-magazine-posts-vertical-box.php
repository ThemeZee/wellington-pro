 ...
 */
class Wellington_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'wellington-magazine-vertical-box', // ID.
			esc_html__( 'Magazine (Vertical Box)', 'wellington-pro' ), // Name.
			array(
				'classname' => 'wellington-magazine-vertical-box-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a vertical box. Please use this widget ONLY in the Magazine Homepage widget area.', 'wellington-pro' ),
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = wellington_get_magazine_post_ids( $this->id, $settings['category'], 5 );
