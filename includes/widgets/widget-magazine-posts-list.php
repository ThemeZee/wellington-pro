...
class Wellington_Pro_Magazine_Posts_List_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from a selected category in a simple list layout.', 'wellington-pro' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (List)', 'wellington-pro' ),
			'category' => 0,
			'number'   => 3,
		);
