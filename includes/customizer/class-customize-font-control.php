...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Wellington_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'wellington-pro' ),
				'next'     => esc_html__( 'Next Font', 'wellington-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'wellington-pro' ),
			);

			// Set Fonts.
			$this->local_fonts = Wellington_Pro_Custom_Fonts::get_local_fonts();
			$this->google_fonts = Wellington_Pro_Custom_Fonts::get_google_fonts();
				...
				<label>
					...
					<div class="customize-font-select-control">
						<select <?php $this->link(); ?>>
							<optgroup label="<?php esc_html_e( 'Local Fonts', 'wellington-pro' ); ?>">
								<?php
							...
							<optgroup label="<?php esc_html_e( 'Google Web Fonts', 'wellington-pro' ); ?>">
	  							<?php
