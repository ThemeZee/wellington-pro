...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Wellington_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'wellington-pro-custom-font-control', WELLINGTON_PRO_PLUGIN_URL . 'assets/js/custom-font-control.js', array( 'customize-controls' ), '20201101', true );
		}
