 ...
 */
 ...
 ( function() {
	...
	document.addEventListener( 'DOMContentLoaded', function() {
		...
		scrollButton.setAttribute( 'aria-label', wellingtonProScrollToTop.label );
		scrollButton.classList.add( 'scroll-to-top-button' );

		// Add icon to Scroll to Top button.
		var icon = new DOMParser().parseFromString( wellingtonProScrollToTop.icon, 'text/html' ).body.firstElementChild;
