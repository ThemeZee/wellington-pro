=== Wellington Pro ===
Plugin URL: https://themezee.com/addons/wellington-pro/
...
Adds additional features and customization options to the Wellington theme.

== Description ==

The *Wellington Pro* plugin adds additional features to the Wellington theme.
...
1. Install the Wellington Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Wellington Theme Documentation](https://themezee.com/docs/wellington-documentation/ "Wellington Theme Documentation").
